...
| `qa-smoke-ci-profile`              | Two self-contained balanced QA Smoke profile parts; channel-compatible subruns execute concurrently inside their assigned part                                                                     | Node-relevant changes                               |
